...
<body>
    <?php
       ...
       if($u_image==''){
       echo "<script type='text/javascript'>alert('Please Select Profile')</script>";
       echo "<script type='text/javascript'>window.open('upload.php','_self')</script>";
       exit();
   }else{
       move_uploaded_file($image_tmp,"images/$u_image.$random_number");
       $update="update signup set user_profile='images/$u_image.$random_number' where user_email='$user'";
